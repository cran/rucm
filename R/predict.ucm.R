...
#'
#'@import KFAS
#'@description Function \code{predict.ucm} predicts the future observations of an Unobserved Components Model. The \code{ucm} function returns an object \code{model} of class \code{\link{SSModel}} which is then further used in the \code{\link{predict.SSModel}}.
#'
#'@param object an object of class \code{SSModel} which can be retrieved from $model call of from an object of class \code{ucm}.
